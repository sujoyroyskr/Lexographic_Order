...
public class assign2
{
    ...
    public static int getBinaryLength (String input)
    {
        int first1 = input.indexOf('1');
        return input.length() - first1;
    }

    public static String question2MainFunc (String input)
    {
        int binaryLength = getBinaryLength(input);
        input = incrementBinary(input);

        if(getBinaryLength(input) != binaryLength)
    ...
    public static void main (String [] args)
    {
        ...
        String output1 = question1MainFunc (input);
        String output2 = question2MainFunc (input);
